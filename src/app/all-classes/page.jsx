...
import ClassSearchBox from "@/components/classes/ClassSearchBox";
  ...
  return (
    <div className="container mx-auto px-4 py-12 mt-16 flex flex-col gap-8">
      ...
      {classes.length > 0 ? (
        ...
        <div className="w-full min-h-122.5 flex flex-col items-center justify-center p-8 bg-linear-to-b from-white/40 to-white/10 dark:from-neutral-900/40 dark:to-neutral-900/10 backdrop-blur-xl rounded-3xl border border-white/40 dark:border-neutral-800/50 shadow-2xl relative overflow-hidden group">
