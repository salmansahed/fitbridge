...
const CorePillars = () => {
  ...
  return (
    <section className="py-24 dark:bg-black overflow-hidden">
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        {/* Right Column: 4 Exclusive Feature Cards (Grid Span: 7) */}
        <div className="lg:col-span-7 space-y-4">
          {pillars.map((pillar, index) => (
            ...
            >
              {/* Icon Box - Will show gradient background on hover */}
