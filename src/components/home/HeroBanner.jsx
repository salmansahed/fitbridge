...
const HeroBanner = () => {
  ...
  return (
    <motion.section
      ...
      initial="hidden"
      animate="visible"
      className="py-20 flex items-center dark:bg-black overflow-hidden px-3"
    >
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 space-y-6 md:space-y-8 text-center lg:text-left">
          <motion.div
            variants={itemVariants}
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-900/50 text-green-600 dark:text-green-400 text-xs md:text-sm font-medium tracking-wide"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="pt-6 border-t border-gray-200 dark:border-neutral-800/60 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto lg:mx-0"
          >
        ...
        <motion.div
          variants={itemVariants}
          className="lg:col-span-5 relative grid grid-cols-12 gap-4 h-112.5 md:h-137.5 w-full mt-8 lg:mt-0"
        >
